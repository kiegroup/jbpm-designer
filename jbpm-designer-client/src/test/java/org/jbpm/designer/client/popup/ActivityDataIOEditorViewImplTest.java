...
public class ActivityDataIOEditorViewImplTest {
    ...
    public void testSetInputAssignmentsDisallowedNames() {
        Set<String> names = new HashSet<String>(Arrays.asList("nameA", "nameB"));
        view.setInputAssignmentsDisallowedNames(names);
        verify(inputAssignmentsWidget).setDisallowedNames(names, DesignerEditorConstants.INSTANCE.This_input_should_be_entered_as_a_property_for_the_task());
    }
