...
ORYX.DataIOEditorUtils = {
    ...
    setAssignmentsPropertyForCustomAssignment: function(facade, element, key, oldValue, newValue){
        ...
        var testConstAssignment = '[din]' + propName + '=' + oldValue;
        ...
        if (oldAssignments !== undefined && oldAssignments.length > 0) {
            if (oldAssignments.includes(testConstAssignment)) {
                newAssignments = oldAssignments.replace(testConstAssignment, newConstAssignment);
