    ...
    <xsl:template match="/">
      ...
      <xsl:text>
         ...
         h1, h2, h3 {
            ...
            <body>
                <xsl:for-each select="//rdf:Description[oryx:type='BPMNDiagram']">
                    <div class="BPMNDiagram">
                    <h1><xsl:value-of select="oryx:name" /></h1>
                    <p><xsl:value-of select="oryx:documentation" /></p>
                    <xsl:for-each select="//rdf:Description[oryx:type='Pool' and raziel:parent/@rdf:resource = current()/@rdf:about]">
                        <div class="Pool">
                        ...
                        <xsl:for-each select="//rdf:Description[oryx:type='Lane' and raziel:parent/@rdf:resource = current()/@rdf:about]">
                            <div class="Lane">
                            <xsl:if test="string-length(oryx:name) &gt; 0">
                            ...
                            <xsl:for-each select="//rdf:Description[oryx:type='Task' and raziel:parent/@rdf:resource = current()/@rdf:about]">
                                <div class="Task">
                                <xsl:if test="string-length(oryx:name) &gt; 0">
