...
/**
 * Simple class to store errors that occured during the transformation.  
 * The errors are combined in a string and separated with new lines.
 */
public class TransformationErrors implements Output {
	
	private String errors = null;
	private static final String newLine = System.getProperty("line.separator");
	private static final String PREFIX = "Transformation Error: ";
	
	/**
	 * Constructor. Initializes the output with an empty string.
	 *
	 */
	public TransformationErrors() {
		this.errors = "";
	}
