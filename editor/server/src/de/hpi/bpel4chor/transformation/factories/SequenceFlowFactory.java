 ...
 * 
 * <p>The factory uses the {@link Componentizer} to determine patterns
...
public class SequenceFlowFactory {
	 ...
	 * (see {@link StructuredElementsFactory#createLoopElement(Activity, Element)}),
	 ...
	 * of the component (see {@link #foldComponent(Component, List)}).
	 * 
	 ...
	 * {@link Componentizer#getNextComponent()}).
