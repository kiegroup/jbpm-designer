...
public class SimpleTest extends AbstractIBPMNTest {
	...
	public void testSimple1() throws Exception {
		...
		Node i3 = addInteraction(factory.createEndInteraction(), "i3", p1, p2, ibpmn);
		...
		assertEquals(9, bpmn.getEdges().size());
		...
		assertTrue(l.getChildNodes().get(3) instanceof EndMessageEvent);
	...
	public void testSimple2() throws Exception {
		...
		Node i3 = addInteraction(factory.createEndInteraction(), "i3", p3, p1, ibpmn);
		...
		assertEquals(10, bpmn.getEdges().size());
		Pool p = (Pool)bpmn.getChildNodes().get(0);
		assertEquals(1, p.getChildNodes().size());
		Lane l = (Lane)p.getChildNodes().get(0);
		assertEquals(4, l.getChildNodes().size());
		...
		assertTrue(l.getChildNodes().get(3) instanceof IntermediateMessageEvent);
