...
/**
 * Class for the mapping of an 'empty' activity. Actually, this activity does
 * not have to be mapped, as it is applied solely in the following scenarios in
 * BPEL: <li>to provide an explicit synchronisation point for control links</li>
 ...
 * the 'empty' activity to a plain intermediate event, which might be removed
 * again as part of the postprocessing.
 * 
