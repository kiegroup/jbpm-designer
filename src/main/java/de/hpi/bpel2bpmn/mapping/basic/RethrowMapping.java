...
/**
 * Please note that the rethrow activity always maps to an intermediate event
 * first. However, it might this event might later be replaced by an end event
 * in the course of a post processing of the model.
 * 
