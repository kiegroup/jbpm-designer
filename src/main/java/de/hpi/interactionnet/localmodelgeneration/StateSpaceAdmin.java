...
public class StateSpaceAdmin {
    ...
    // // brute force...
    // Set<String> markings = new HashSet<String>();
    // return isReachableMarking(net.getInitialMarking(), m.toString(),
    // markings);
    // }
    //
    // private boolean isReachableMarking(Marking marking, String m, Set<String>
    // markings) {
    // String markingStr = marking.toString();
    ...
    // markings.add(markingStr);
    //
    // List<Transition> transitions = interpreter.getEnabledTransitions(net,
    // marking);
    // for (Transition t: transitions) {
    // Marking newmarking = interpreter.fireTransition(net, marking, t);
