    ...
    protected void setupShareRole() {
        ...
        for (Iterator iter = net.getTransitions().iterator(); iter.hasNext();) {
            ...
            for (Iterator iter2 = net.getTransitions().iterator(); iter2.hasNext();) {
                ...
                shareRole[x1][x2] = (i1.getSender().equals(i2.getSender()) || i1.getSender().equals(i2.getReceiver())
                        || i1.getReceiver().equals(i2.getSender()) || i1.getReceiver().equals(i2.getReceiver()));
                x2++;
            }
            x1++;
        }
