...
public class IBPMNRDFImporter {
    ...
    protected class ImportContext {
        ...
        Map<String, de.hpi.bpmn.DiagramObject> objects = new HashMap<String, de.hpi.bpmn.DiagramObject>(); // key
                                                                                                           // =
                                                                                                           // resource
                                                                                                           // id,
                                                                                                           // value
                                                                                                           ...
                                                                                                           // diagram
                                                                                                           // object
        Map<String, de.hpi.bpmn.DiagramObject> connections = new HashMap<String, de.hpi.bpmn.DiagramObject>(); // key
                                                                                                               // =
                                                                                                               // to
                                                                                                               // resource
                                                                                                               // id,
                                                                                                               ...
                                                                                                               // from
                                                                                                               // node
        Map<de.hpi.bpmn.Node, String> parentRelationships = new HashMap<de.hpi.bpmn.Node, String>(); // key
                                                                                                     // =
                                                                                                     // child
                                                                                                     // node,
                                                                                                     // value
                                                                                                     ...
                                                                                                     // resource
                                                                                                     // id
        Map<de.hpi.bpmn.DiagramObject, String[]> owningRolesMap = new HashMap<de.hpi.bpmn.DiagramObject, String[]>(); // key
                                                                                                                      // =
                                                                                                                      // node,
                                                                                                                      // value
                                                                                                                      // =
    ...
    // protected void addIntermediateCompensationEvent(Node node, ImportContext
    // c) {
    // IntermediateCompensationEvent event =
    // factory.createIntermediateCompensationEvent();
    // handleEvent(node, event, c, "target");
    // }

    // protected void addIntermediateRuleEvent(Node node, ImportContext c) {
    // IntermediateConditionalEvent event =
    // factory.createIntermediateConditionalEvent();
    // handleEvent(node, event, c, "ruleName");
    // }
    ...
    // IntermediateMultipleEvent event =
    // factory.createIntermediateMultipleEvent();
    // handleEvent(node, event, c, "triggers");
    // }
    ...
    protected void addMessageFlowFrom(Node node, ImportContext c) {
        Edge temp = new MessageFlow(); // only created temporarily - will not
                                       // appear in diagram
