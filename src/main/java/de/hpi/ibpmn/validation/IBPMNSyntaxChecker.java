...
public class IBPMNSyntaxChecker extends BPMNSyntaxChecker {
    /*
     * protected static final String NO_ROLE_SET =
     * "Interactions must have a sender and a receiver role set"; protected
     * static final String NO_INCOMING_SEQFLOW =
     * "This node must have incoming sequence flow."; protected static final
     * String NO_OUTGOING_SEQFLOW =
     * "This node must have outgoing sequence flow.";
     */
