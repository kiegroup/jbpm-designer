...
class File_Archive
{
                  ...
                  $uncompression = 0, $directoryDepth = -1)
    {
        ...
        if ((empty($URL) || is_dir($URL)) && $source === null) {
            require_once "Bpel/Archive/Reader/Directory.php";
            require_once "Bpel/Archive/Reader/ChangeName.php";

            if ($uncompressionLevel != 0) {
                require_once "Bpel/Archive/Reader/Uncompress.php";
        ...
        //Else, we will have to build a complex reader
            ...
            if ($source === null) {
                ...
                require_once "Bpel/Archive/Reader/Select.php";
            ...
            if ($directoryDepth >= 0) {
                ...
                require_once "Bpel/Archive/Predicate/MaxDepth.php";
...
/*        case 'cab':
        ...
        case 'rar':
            require_once "Bpel/Archive/Reader/Rar.php";
    ...
    {
        require_once "Bpel/Archive/Reader/Multi.php";
    ...
    function readConcat(&$toConvert, $filename, $stat=array(), $mime=null)
    {
        ...
        require_once "Bpel/Archive/Reader/Concat.php";
    ...
    function filter($predicate, &$toConvert)
    {
        ...
        require_once "Bpel/Archive/Reader/Filter.php";
    ...
    function predTrue()
    {
        require_once "Bpel/Archive/Predicate/True.php";
    ...
    function predAnd()
    {
        require_once "Bpel/Archive/Predicate/And.php";
    ...
    function predOr()
    {
        require_once "Bpel/Archive/Predicate/Or.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/Not.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/MinSize.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/MinTime.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/Extension.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/MIME.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/Ereg.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/Eregi.php";
    ...
    {
        require_once "Bpel/Archive/Predicate/Custom.php";
    ...
    {
        require_once "Bpel/Archive/Writer/Mail.php";
    ...
    function toMulti(&$aC, &$bC)
    {
        ...
        require_once "Bpel/Archive/Writer/Multi.php";
        $writer = new File_Archive_Writer_Multi();
        $writer->addWriter($a);
        $writer->addWriter($b);
        return $writer;
    ...
    {
        require_once "Bpel/Archive/Writer/Output.php";
                                 ...
                                 $type = null, $stat = array())
    {
        ...
        if (!PEAR::isError($result)) {
            if ($unique) {
                require_once "Bpel/Archive/Writer/UniqueAppender.php";
        ...
        if (empty($baseDir)) {
            ...
            if (PEAR::isError($result)) {
                require_once "Bpel/Archive/Writer/AddBaseName.php";
    ...
    function removeDuplicatesFromSource(&$toConvert, $URL = null)
    {
        ...
        require_once "Bpel/Archive/Predicate/Duplicate.php";
