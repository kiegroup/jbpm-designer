...
public class SyntaxCheckerErrors {
    ...
    public static final String THE_SUM_OF_PROBABILITY_VALUES_OF_ALL_OUTGOING_SEQUENCE_FLOWS_MUST_BE_EQUAL_100 = "The sum of probability values of all outgoing Sequence Flows must be equal 100.";
