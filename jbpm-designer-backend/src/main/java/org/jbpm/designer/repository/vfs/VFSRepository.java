...
public class VFSRepository implements Repository {
    ...
    public void createGlobalDirOnNewProject(@Observes NewProjectEvent newProjectEvent) {
        ...
        if (!ioService.exists(globalDirVFSPath)) {
            ...
            List<String> defaultEmptyFormTemplates = Arrays.asList("backboneformsinclude.fw",
            ...
            try {
                writeToGlobalDir(designerContext,
                                 ...
                                 separator,
                                 true,
                                 defaultEmptyFormTemplates);
            } catch (Exception e) {
                logger.error("Unable to create default form templates.");
            }
