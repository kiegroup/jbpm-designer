...
public class TransformerServletTest  extends RepositoryBaseTest {
    ...
    private static final String TEST_HTML = "<html><head></head><body><div><p>Test String</p></div></body>";
    ...
    public void testTransformHtmlToPdf() throws Exception {
        ...
        Map<String, String> params = new HashMap<String, String>();
        params.put("htmlenc", TEST_HTML_ENCODED);
        params.put("uuid", id);
        params.put("profile", JBPM_PROFILE_NAME);
        params.put("transformto", transformType);
        params.put("processid", BP_NAME);
