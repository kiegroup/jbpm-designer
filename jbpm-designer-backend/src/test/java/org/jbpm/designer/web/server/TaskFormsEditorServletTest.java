...
public class TaskFormsEditorServletTest  extends RepositoryBaseTest {
    ...
    public void testSaveNotExistingTaskForm() throws Exception {
        ...
        Collection<Asset> formForms = repository.listAssets("/defaultPackage", new FilterByExtension("form"));
        assertNotNull(formForms);
        assertEquals(1, formForms.size());
        ...
        Collection<Asset> ftlForms2 = repository.listAssets("/defaultPackage", new FilterByExtension("ftl"));
        assertNotNull(ftlForms2);
        // ftl forms are retired. Should not get generated
        assertEquals(0, ftlForms2.size());

        Collection<Asset> frmForms = repository.listAssets("/defaultPackage", new FilterByExtension("frm"));
        assertNotNull(frmForms);
        assertEquals(1, frmForms.size());
