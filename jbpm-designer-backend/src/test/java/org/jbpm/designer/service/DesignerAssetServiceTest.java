...
public class DesignerAssetServiceTest extends RepositoryBaseTest {
    ...
    public void testGetEditorParameters() throws Exception {
        ...
        when(assetService.getEditorParameters(any(org.uberfire.backend.vfs.Path.class), anyString(), anyString(), any(org.uberfire.mvp.PlaceRequest.class))).thenAnswer(new Answer<String>() {
            @Override
            public String answer(InvocationOnMock invocation) throws Throwable {
