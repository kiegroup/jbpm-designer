...
public class BPMN2SyntaxCheckerTest {
    ...
    public void testNoCalledElementCallActivity() throws Exception {
        ...
        String processJson = loader.getProcessJson();
        BPMN2SyntaxChecker syntaxChecker = new BPMN2SyntaxChecker(processJson, "", loader.getProfile());
        verifyErrorsOfElement(syntaxChecker, callActivity, Arrays.asList(SyntaxCheckerErrors.REUSABLE_SUBPROCESS_HAS_NO_CALLED_ELEMENT_SPECIFIED));
    }
    ...
    public void testScriptTaskNoScriptNoLanguage() throws Exception {
        ...
        String processJson = loader.getProcessJson();
        BPMN2SyntaxChecker syntaxChecker = new BPMN2SyntaxChecker(processJson, "", loader.getProfile());
        verifyErrorsOfElement(syntaxChecker, task, Arrays.asList(SyntaxCheckerErrors.SCRIPT_TASK_HAS_NO_SCRIPT,
                                                                 SyntaxCheckerErrors.SCRIPT_TASK_HAS_NO_SCRIPT_FORMAT));
    }
    ...
    public void testScriptTaskNoLanguage() throws Exception {
        ...
        String processJson = loader.getProcessJson();
        BPMN2SyntaxChecker syntaxChecker = new BPMN2SyntaxChecker(processJson, "", loader.getProfile());
        verifyErrorsOfElement(syntaxChecker, task, Arrays.asList(SyntaxCheckerErrors.SCRIPT_TASK_HAS_NO_SCRIPT_FORMAT));
    }
    ...
    public void testErrorBoundaryEventMissingDefinition() throws Exception {
        ...
        String processJson = loader.getProcessJson();
        BPMN2SyntaxChecker syntaxChecker = new BPMN2SyntaxChecker(processJson, "", loader.getProfile());
        verifyErrorsOfElement(syntaxChecker, error, Arrays.asList(SyntaxCheckerErrors.CATCH_EVENT + SyntaxCheckerErrors.HAS_NO_ERRORREF));
    }
    ...
    public void testServiceTaskNoInterfaceNoOperation() throws Exception {
        ...
        String processJson = loader.getProcessJson();
        BPMN2SyntaxChecker syntaxChecker = new BPMN2SyntaxChecker(processJson, "", loader.getProfile());
        verifyErrorsOfElement(syntaxChecker, serviceTask, Arrays.asList(SyntaxCheckerErrors.SERVICE_TASK_HAS_NO_OPERATION));
    }
