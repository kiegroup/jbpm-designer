...
<div id="login-wrapper" class="png_bg">
    <div id="login-top">
        <img src="<%=request.getContextPath()%>/org.jbpm.designer.jBPMDesigner/images/uf_logo.png" alt="UberFire Logo" title="Powered By Uberfire"/>
    </div>
